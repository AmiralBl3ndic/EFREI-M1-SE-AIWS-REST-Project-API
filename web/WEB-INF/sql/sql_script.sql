...
CREATE TABLE VG_RATINGS(
            ...
            CONSTRAINT FK_USER_RATING FOREIGN KEY (ID_USER_RATING) REFERENCES  USERS (ID_USER),
...
CREATE TABLE BOOK_COMMENTS(
    ...
    CONSTRAINT FK_COMMENTER FOREIGN KEY (ID_COMMENTER) REFERENCES  USERS (ID_USER),
