...
public class BookDAOImpl implements DAO<Book> {
	...
	public void create(@NonNull Book book) {
		...
		try {
			...
			preparedStatement = DAOUtils.initPreparedStatement(connection, SQL_INSERT_BOOK, true, bookID, userID, author, title, type, description, releaseDate, editor);
	 ...
	 * @return List of all {@link Comment}s related to book record with id {@code idBook}
	 */
	...
	/**
	 * Creates a database record of the passed in {@link Book} {@link Comment}
	 * @param comment {@link Book} comment with all its fields set to non-null values
	 */
