...
public class VideoGameDAOImpl implements DAO<VideoGame> {
    ...
    private static final String SQL_UPTDATE_VIDEOGAME = "UPDATE VIDEOGAMES SET ID_VIDEO_GAME = ?, ID_USERS = ?, NAME = ?, TYPE = ?, RESUME = ?, VIDEO_GAME_EDITOR = ?, RELEASEDATE = ?, VG_RATING = ? WHERE ID_VIDEO_GAME = ?";
    private static final String SQL_DELETE_USER = "DELETE FROM VIDEOGAMES WHERE ID_VG = ?";
    ...
    public void create(@NonNull VideoGame videoGame) {
        ...
        try {
            ...
            else logger.log(Level.INFO, "error in the creation of the video game : unable to generate proper Id");
    ...
    public void update(@NonNull VideoGame videoGame) {
        ...
        try {
            connection = this.daofactory.getConnection();
            preparedStatement = DAOUtils.initPreparedStatement(connection, SQL_UPTDATE_VIDEOGAME, false, videoGame.getVideoGameId(), videoGame.getUserId(), videoGame.getName(), videoGame.getType(), videoGame.getResume(), videoGame.getEditor(), videoGame.getReleaseDate(), videoGame.getRating());
