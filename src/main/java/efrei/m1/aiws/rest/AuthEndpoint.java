...
import efrei.m1.aiws.model.requests.AuthRequest;
import efrei.m1.aiws.model.requests.AuthResponse;
...
public class AuthEndpoint {
	 ...
	 * @return HTTP {@link Response} in the form of a {@link AuthResponse} JSON object
	 */
	@POST
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public Response authenticate(AuthRequest body) {
